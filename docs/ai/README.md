...
4. 当前 active task：`tasks/2026-08-17-stage-24-2-unread-enter.md`。
...
- **Active**：`2026-08-17-stage-24-2-unread-enter.md`。
- **Historical**：Stage 22、Stage 23、Stage 24/24.1 的 dated task；相关实现已经进入 `origin/main@67fcab4`，这些文件只保留决策与历史证据。
