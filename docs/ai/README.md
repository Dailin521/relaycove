...
4. 当前活动问题是 `tasks/2026-08-25-stage-38-official-presence-display.md`，父计划是 `tasks/2026-08-25-v2-optimization-plan.md`；已完成的 `v2.1.0` 发布记录是 `tasks/2026-08-25-v2-1-release.md`。Stage 37 已随 `main@b0fb6ee` 交付，Stage 32 精确锚点和 Stage 34 reaction 面板定位仍等待最终确认，此前其他 dated Stage 和发布记录只作历史证据。
...
- **Active**：Stage 38 Zulip 官方在线状态与个人状态显示；父计划为 V2 总优化计划。
