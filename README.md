...
当前正式版本为 [`2.3.1`](https://github.com/Dailin521/relaycove/releases/tag/v2.3.1)，目标平台为 Windows 11 x64，使用 .NET SDK `10.0.400`、MAUI `10.0.20` 和 `win-x64`。`RelayCove.Web` 只保留为历史源码，不再参与产品开发或 Windows 发布。
